...
| 순서 | 스크립트        | 역할                                                           | 실행 조건 | 상세                                                                                                                                |
|:--:|-------------|--------------------------------------------------------------|-------|-----------------------------------------------------------------------------------------------------------------------------------|
| 10 | ai-core     | Claude Code, Codex CLI, Gemini CLI, Copilot CLI, Hermes Agent, superpowers | 최초 1회 | 공식 AI CLI 도구 5종 설치 + superpowers를 ~/superpowers에 clone. Claude Code와 Hermes는 공식 설치 스크립트(curl), 나머지 3종은 npm. 확장 환경 구성은 개별 스크립트(11~14)에서 처리 |
...
| 04 | ai-tools         | claude, codex, hermes, oh-my-codex, opencode, oh-my-opencode, gemini | 최초 1회             | macOS와 동일한 AI 스택을 최소 구성으로 설치                                     |
