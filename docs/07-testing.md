...
- 설정 템플릿 34개, 스크립트 19개(darwin 13, linux 6)를 대상으로 함
...
- 매 실행마다 클린 환경이 보장됨
- 스크립트 실행(`run_once_before_01`, `run_onchange_02`, `run_onchange_03`, `run_once_04`, `run_onchange_05`, `run_onchange_15`)도 안전하게 검증 가능
